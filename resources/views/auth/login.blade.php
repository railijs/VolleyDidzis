...
<body>
        ...
        <div class="page__left">
            <div>
                ...
                <div class="hero-head reveal" data-stagger="1">
                    ...
                    <h1 class="hero-head__title">Laipni<br>lūdzam<br><em>atpakaļ</em></h1>
                </div>

                <p class="hero-copy reveal" data-stagger="2">
                    Ienāc, lai sekotu saviem turnīriem, pārvaldītu komandas un lasītu jaunākās ziņas.
                </p>

                <a href="{{ route('register') }}" class="register-link reveal" data-stagger="3">
        ...
        <div class="page__right">
            <div style="max-width:420px; width:100%; margin:0 auto;">
                ...
                <div class="form-header reveal" data-stagger="0">
                    <div class="form-header__title">Ienākt</div>
                    <div class="form-header__sub">Ievadi savu e-pastu un paroli.</div>
                </div>
                ...
                @endif
                @if (session('status'))
                    <div class="alert alert--success reveal" data-stagger="1">{{ session('status') }}</div>
                @endif

                <form method="POST" action="{{ route('login') }}" class="reveal" data-stagger="1">
                    @csrf
                    ...
                    <div class="form-actions">
                        <a href="{{ route('register') }}" class="form-link">Nav konta? Reģistrēties</a>
                        <button type="submit" class="btn-submit">Ienākt →</button>
                    </div>
                </form>

                @if (Route::has('guest.login'))
                    <form method="POST" action="{{ route('guest.login') }}" class="guest-form reveal" data-stagger="2">
                        @csrf
                        <button type="submit" class="btn-guest">Turpināt kā viesim</button>
                    </form>
                @endif
    ...
    <script>
        ...
        // Stagger reveals on right panel
